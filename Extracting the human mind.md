...
1. **본인 언어 그대로 (Verbatim):** 정규화·요약·환언을 금지한다. 예외적으로 래더링과 클린 랭귀지 기법에서만 LLM이 보조자(꼬리질문/고정 템플릿)로 루프에 참여하며, 클린 랭귀지는 질문 문장을 상수로 고정하고 슬롯에 사용자 원문 토큰만 허용해 청결도를 구조로 강제한다.
...
graph TD
    ...
    M1 & M2 & M3 & M4 & M5 & M6 & M7 & M8 & M9 & M10 & M11 & D1 & D2 & D3 & D4 & D5 -.->|Raw Data 누적| V1
    V1 -->|베이스라인 초과 시 해금| O1
```
